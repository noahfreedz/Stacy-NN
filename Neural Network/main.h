...
namespace Stacy {
    ...
    #pragma region Weight & Bias Initalizations
        ...
        double get_xavier_weight() {
            ...
            int input_count = network_biases.front().size();
            int output_count = network_biases.back().size();
        ...
        // Returns small constant to ensure ReLU neurons activate initially.
        double get_relu_bias() {
            return 0.01;
        }
